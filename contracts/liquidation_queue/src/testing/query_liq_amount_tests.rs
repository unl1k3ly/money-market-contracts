...
use cosmwasm_std::{from_binary, to_binary, BankMsg, Coin, CosmosMsg, Decimal, HumanAddr, Uint128};
use cw20::Cw20ReceiveMsg;
use moneymarket::liquidation_queue::{
    Cw20HookMsg, HandleMsg, InitMsg, LiquidationAmountResponse, QueryMsg,
};
...
fn partial_one_collateral_one_slot_high_ltv() {
    ...
    deps.querier
        .with_collateral_max_ltv(&[(&HumanAddr::from("token0000"), &Decimal256::percent(90))]);
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(20000u64))], // value 20000 (LTV 90%), limit = 18,000
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(16433u64))],
        }
    );
...
fn partial_one_collateral_one_slot() {
    ...
    deps.querier
        .with_collateral_max_ltv(&[(&HumanAddr::from("token0000"), &Decimal256::percent(50))]);
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(20000u64))],
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(7291u64))],
        }
    );
    ...
    deps.querier.with_oracle_price(&[(
        &("token0000".to_string(), "uusd".to_string()),
        &(Decimal256::percent(10), env.block.time, env.block.time),
    )]);
...
fn partial_one_collateral_one_slot_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(7551u64))],
        }
    );
...
fn partial_one_collateral_two_slots() {
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(200000u64))],
        collateral_prices: vec![Decimal256::percent(10)],
    };
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(42861u64))],
        }
    );
...
fn partial_one_collateral_two_slots_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(44453u64))],
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(4077u128), // repay amount = 4076
                }]
            }),
            CosmosMsg::Bank(BankMsg::Send {
                from_address: HumanAddr::from(MOCK_CONTRACT_ADDR),
...
fn non_partial_liquidation() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(12643u64))],
        }
    );
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(1200u128), // repay all borrowed amount, overpay
            }]
        })]
    );
}
...
fn non_partial_liquidation_two_slots() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(12756u64))],
        }
    );
...
fn non_partial_liquidation_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(12899u64))],
        }
    );
...
fn non_partial_liquidation_two_slots_with_fees() {
    ...
    assert_eq!(
        res,
        LiquidationAmountResponse {
            collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(13015u64))],
        }
    );
...
fn non_partial_liquidation_two_slots_with_fees_big_nums() {
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![(HumanAddr::from("token0000"), Uint256::from(20000000000u64))], // value = 2,000,000,000
        collateral_prices: vec![Decimal256::percent(10)],
    };
    ...
    assert_eq!(
        ...
        vec![
            ...
            CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(13132626u128),
                }]
            })
        ]
    );
...
fn partial_two_collaterals_ltv_diff() {
    ...
    deps.querier.with_collateral_max_ltv(&[
        (&HumanAddr::from("token0000"), &Decimal256::percent(99)),
        (&HumanAddr::from("token0001"), &Decimal256::percent(1)),
    ]);
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        borrow_limit: Uint256::from(1000000000u64),
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(1000000000u64)), // value = 1000000000 (LTV 99%) limit = 990..
            (HumanAddr::from("token0001"), Uint256::from(1000000000u64)), // value = 1000000000 (LTV 1%) limit = 10..
        ],
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(19230775u64)),
                (HumanAddr::from("token0001"), Uint256::from(399193550u64))
            ],
        }
    );
...
fn partial_two_collaterals_multi_slots_per_col() {
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(20000u64)), // value = 2000 (LTV = 50%) limit = 1000
            (HumanAddr::from("token0001"), Uint256::from(30000u64)), // value = 1500 (LTV = 30%) limit = 450
        ],
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(3796u64)),
                (HumanAddr::from("token0001"), Uint256::from(9637u64))
            ],
        }
    );
    ...
    deps.querier.with_oracle_price(&[
        ...
        (
            &("token0001".to_string(), "uusd".to_string()),
            &(Decimal256::percent(5), env.block.time, env.block.time),
        ),
    ]);
...
fn partial_two_collaterals_one_slot_diff_ltv() {
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(3037u64)),
                (HumanAddr::from("token0001"), Uint256::from(7775u64))
            ],
        }
    );
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(287u128), // col1 repay = 288
            }]
        })]
    );
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(368u128), // col2 repay = 369
            }]
        })]
    );
}
...
fn partial_three_collaterals_one_slot_diff_ltv() {
    ...
    deps.querier.with_collateral_max_ltv(&[
        (&HumanAddr::from("token0000"), &Decimal256::percent(50)),
        (&HumanAddr::from("token0001"), &Decimal256::percent(70)),
        (&HumanAddr::from("token0002"), &Decimal256::percent(30)),
    ]);
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(20000u64)), // value = 2000 LTV = 50% (limit = 1000)
            (HumanAddr::from("token0001"), Uint256::from(30000u64)), // value = 1500 LTV = 70% (limit = 1,050)
            (HumanAddr::from("token0002"), Uint256::from(6000u64)), // value = 6600 LTV = 30% (limit = 1,980)
        ],
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(3328u64)),
                (HumanAddr::from("token0001"), Uint256::from(5824u64)),
                (HumanAddr::from("token0002"), Uint256::from(1210u64)),
            ],
        }
    );
    ...
    deps.querier.with_oracle_price(&[
        ...
        (
            ...
            &(Decimal256::percent(110), env.block.time, env.block.time),
        ),
    ]);
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(315u128), // col1 repay = 316
            }]
        })]
    );
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Bank(BankMsg::Send {
            ...
            amount: vec![Coin {
                denom: "uusd".to_string(),
                amount: Uint128::from(261u128), // col2 repay = 262
            }]
        })]
    );
...
fn partial_three_collaterals_one_slot_diff_ltv_big_amounts() {
    ...
    deps.querier.with_collateral_max_ltv(&[
        (&HumanAddr::from("token0000"), &Decimal256::percent(50)),
        (&HumanAddr::from("token0001"), &Decimal256::percent(40)),
        (&HumanAddr::from("token0002"), &Decimal256::percent(30)),
    ]);
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(200000000000u64)), // value = 2,000,000,000,000 LTV = 50% (limit = 1,000,000,000,000)
            (HumanAddr::from("token0001"), Uint256::from(3000000000u64)), // value = 15,000,000,000 LTV = 40% (limit = 6,000,000,000)
            (HumanAddr::from("token0002"), Uint256::from(60000000u64)), // value = 6,600,000,000 LTV = 30% (limit = 1,980,000,000)
        ],
        collateral_prices: vec![
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(69498951644u64)),
                (HumanAddr::from("token0001"), Uint256::from(2471406687u64)),
                (HumanAddr::from("token0002"), Uint256::from(50965898u64)),
            ],
        }
    );
    ...
    deps.querier.with_oracle_price(&[
        ...
        (
            &("token0001".to_string(), "uusd".to_string()),
            &(Decimal256::percent(500), env.block.time, env.block.time),
        ),
        (
            &("token0002".to_string(), "uusd".to_string()),
            &(Decimal256::percent(11000), env.block.time, env.block.time),
        ),
    ]);
...
fn partial_three_collaterals_one_slot_diff_ltv_big_amounts_2() {
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(200000000u64)), // value = 2,000,000,000 LTV = 50% (limit = 1,000,000,000)
            (HumanAddr::from("token0001"), Uint256::from(3000000000u64)), // value = 15,000,000,000 LTV = 40% (limit = 6,000,000,000)
            (HumanAddr::from("token0002"), Uint256::from(60000000u64)), // value = 6,600,000,000 LTV = 30% (limit = 1,980,000,000)
        ],
        collateral_prices: vec![
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(21944167u64)),
                (HumanAddr::from("token0001"), Uint256::from(390171057u64)),
                (HumanAddr::from("token0002"), Uint256::from(8046195u64)),
            ],
        }
    );
...
fn not_enough_bids_for_one_of_two_col() {
    ...
    let msg = QueryMsg::LiquidationAmount {
        ...
        collaterals: vec![
            (HumanAddr::from("token0000"), Uint256::from(20000000u64)), // value = 2,000,000 (LTV 50%) limit = 2,000,000
            (HumanAddr::from("token0001"), Uint256::from(30000000u64)), // value = 1,500,000 (LTV 30%) limit = 450,000
        ],
        collateral_prices: vec![Decimal256::percent(10), Decimal256::percent(5)],
    };
    ...
    assert_eq!(
        ...
        LiquidationAmountResponse {
            collaterals: vec![
                (HumanAddr::from("token0000"), Uint256::from(11862304u64)),
                (HumanAddr::from("token0001"), Uint256::from(6541171u64))
            ],
        }
    );
    ...
    assert_eq!(
        ...
        vec![
            CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(1104603u128),
                }]
            }),
            CosmosMsg::Bank(BankMsg::Send {
                from_address: HumanAddr::from(MOCK_CONTRACT_ADDR),
    ...
    assert_eq!(
        ...
        vec![
            CosmosMsg::Bank(BankMsg::Send {
                ...
                amount: vec![Coin {
                    denom: "uusd".to_string(),
                    amount: Uint128::from(288524u128),
                }]
            }),
            CosmosMsg::Bank(BankMsg::Send {
                from_address: HumanAddr::from(MOCK_CONTRACT_ADDR),
